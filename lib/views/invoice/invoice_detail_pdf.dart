...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    fromAsset('assets/files/mau2.pdf', 'corrupted.pdf').then((f) {
      setState(() {
        corruptedPathPDF = f.path;
      });
    });
    fromAsset('assets/files/mau2.pdf', 'demo.pdf').then((f) {
      setState(() {
        pathPDF = f.path;
      });
    });
    fromAsset('assets/files/mau2.pdf', 'landscape.pdf').then((f) {
      setState(() {
